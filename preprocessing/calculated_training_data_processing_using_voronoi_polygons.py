...
parser.add_argument('--output_folder', type=str, default='./AOSLO_dataset_using_voronoi', help='path to output folder')
...
def main():
    ...
    for image_id in tqdm(image_ids):
        ...
        #3. using above polygon coordinates , we fill it with 1. else 0
