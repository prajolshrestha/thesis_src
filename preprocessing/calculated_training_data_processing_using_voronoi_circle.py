...
parser.add_argument('--output_folder', type=str, default='./AOSLO_dataset_using_voronoi_circle', help='path to output folder')
...
def main():
    ...
    for image_id in tqdm(image_ids):
        ...
        for region_index in vor.regions:
            if not -1 in region_index and len(region_index) > 0: # Use bounded regions
